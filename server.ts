...
- Identificado estilo de vida, frequência de viagens e lazer em família (2.5)
- Checou se o perfil se enquadra na política vigente (2.5)
- Quando necessário, solicitou autorização de exceção com responsabilidade (2.5)
...
`;
      ...
      if (!response.ok) {
        ...
        console.error("Erro na OpenRouter:", errorDetail);
      ...
      try {
        ...
        // Tenta extrair JSON do texto bruto se o parse falhou inicialmente
